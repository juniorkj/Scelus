...
public class SentinelaDatasourceConfig {
    ...
    public DataSource sentinelaDataSource(@Qualifier("sentinelaDataSourceProperties") DataSourceProperties props) {
        return props.initializeDataSourceBuilder().type(HikariDataSource.class).build();
    }

    @Bean
    public LocalContainerEntityManagerFactoryBean sentinelaEntityManagerFactory(
            @Qualifier("sentinelaDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
